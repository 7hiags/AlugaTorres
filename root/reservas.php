...
$pageTitle = 'AlugaTorres | Reservas';
$metaDescription = 'Área de reservas dos utilizadores';
$extraHead = '
<style>
.loading-spinner {
    display: flex;
...
<body>
    <div class="reservas-container">
        ...
        <!-- Toast notifications only - no body messages -->
        ...
        <div class="status-filtros">
            ...
            <button class="status-btn" data-status="rejeitada" onclick="filterByStatus('rejeitada')">
                Rejeitadas
            </button>
    ...
    <div class="modal" id="detailsModal">
        <div class="modal-content">
            <h3 class="modal-title">Detalhes da Reserva <span id="modalLoading" style="display:none;"><i class="fas fa-spinner fa-spin"></i></span></h3>
