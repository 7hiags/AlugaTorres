    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-content">
            ...
            <?php if (isset($_SESSION['tipo_utilizador']) && $_SESSION['tipo_utilizador'] !== 'admin'): ?>
                <a href="<?= $BASE_URL ?>root/perfil.php" class="sidebar-item">
                    <i class="fas fa-user-edit"></i> Meu Perfil
                </a>

                <a href="<?= $BASE_URL ?>root/definicoes.php" class="sidebar-item">
            ...
            <?php elseif (isset($_SESSION['tipo_utilizador']) && $_SESSION['tipo_utilizador'] === 'arrendatario'): ?>
                <a href="<?= $BASE_URL ?>root/reservas.php" class="sidebar-item">
            ...
            <a href="<?= $BASE_URL ?>backend/autenticacao/logout.php" class="sidebar-item logout">
