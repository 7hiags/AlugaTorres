...
$result = $conn->query("SELECT COUNT(*) as total FROM utilizadores 
WHERE tipo_utilizador = 'proprietario'");
$stats['total_proprietarios'] = $result->fetch_assoc()['total'];

// Total de arrendatários
$result = $conn->query("SELECT COUNT(*) as total FROM utilizadores 
WHERE tipo_utilizador = 'arrendatario'");
$stats['total_arrendatarios'] = $result->fetch_assoc()['total'];

// Novos utilizadores este mês
$result = $conn->query("SELECT COUNT(*) as total FROM utilizadores 
WHERE MONTH(data_registro) = MONTH(CURRENT_DATE()) AND YEAR(data_registro) = YEAR(CURRENT_DATE())");
...
$result = $conn->query("SELECT COUNT(*) as total FROM reservas 
WHERE MONTH(data_reserva) = MONTH(CURRENT_DATE()) AND YEAR(data_reserva) = YEAR(CURRENT_DATE())");
$stats['novas_reservas_mes'] = $result->fetch_assoc()['total'];

// Receita total estimada
$result = $conn->query("SELECT SUM(total) as total FROM reservas 
...
<?php
$pageTitle = 'AlugaTorres | Admin Dashboard';
